...
void pwc_printCommandHelp() {
	...
	printf("\t\t--buffersize_r (-x) : The size of the Reader Module buffer, in bytes. (Optional)\n");
	printf("\t\t--buffersize_cm (-y) : The size of the Counter-Manager Module buffer, in bytes. (Optional)\n");
	printf("\t\t--buffersize_c (-z) : The size of the Counter Module buffer, in bytes. (Optional)\n");
