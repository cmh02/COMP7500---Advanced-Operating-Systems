...
struct aubatch_configuration {
	...
	bool LOGGING_SEND_ERROR_TO_LOG;
	bool LOGGING_SEND_ERROR_TO_STDOUT;
	bool LOGGING_SEND_WARNING_TO_LOG;
	bool LOGGING_SEND_WARNING_TO_STDOUT;
	bool LOGGING_SEND_INFO_TO_LOG;
	bool LOGGING_SEND_INFO_TO_STDOUT;
	bool LOGGING_SEND_INTERACTIVE_TO_LOG;
	bool LOGGING_SEND_INTERACTIVE_TO_STDOUT;
