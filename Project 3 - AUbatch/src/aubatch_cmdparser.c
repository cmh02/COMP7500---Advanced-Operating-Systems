...
int aubatch_cmdparser_enterCommandLoop() {
	...
	while (true) {
		...
		// Insert job
			...
			aubatch_log(AUBATCH_LOGLEVEL_INTERACTIVE, AUBATCH_MODULE_NAME, AUBATCH_MESSAGE_JOBSUBMISSION, job.name, NULL, NULL, aubatch_schedulingPolicyNames[aubatch_scheduler_getSchedulingPolicy()]);
